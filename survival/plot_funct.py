...
def prettyplot(n_cv, i, survivalloc, analysis_directory, disease_type):
	...
	plt.savefig(analysis_directory+'cv_'+str(n_cv)+ '_results/cv_run'+str(i)+'/model_0_0/learn/expected_values/'+disease_type+ '_EZ_given_x.pdf', bbox_inches='tight')
	plt.savefig(analysis_directory+'cv_'+str(n_cv)+ '_results/cv_run'+str(i)+'/model_0_0/learn/expected_values/'+disease_type+ '_EZ_given_x.eps', format='eps', dpi=1200, bbox_inches='tight')
	ylim= ax.get_ylim()
	xlim= ax.get_xlim()
	...
	plt.savefig(analysis_directory+'cv_'+str(n_cv)+ '_results/cv_run'+str(i)+'/model_0_0/val/'+disease_type+ '_EZ_given_x_val.pdf', bbox_inches='tight')
	plt.savefig(analysis_directory+'cv_'+str(n_cv)+ '_results/cv_run'+str(i)+'/model_0_0/val/'+ disease_type+ '_EZ_given_x_val.eps', format='eps', dpi = 1200, bbox_inches='tight')
